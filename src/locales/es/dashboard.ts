export default {
    ...
    common : {
        ...
        submit: 'Enviar',
        close: 'Cerrar',
        confirmDelete: '¿Está seguro de que desea eliminar este elemento? Esta acción no se puede deshac' +
                'er.'
    },
    ...
    invitations : {
        ...
        otpStep3: 'Después de iniciar sesión, se les pedirá que establezcan su contraseña y complet' +
                'en su perfil',
    ...
    classes : {
        ...
        new: {
            ...
            types: {
                hsk: 'Cursos HSK',
                language: 'Clases de Idioma Chino',
                cultural: 'Clases Culturales',
                talleres: 'Talleres'
            },
            english: 'Inglés',
            spanish: 'Español',
            ...
            createError: 'Error al crear clase',
            genericError: 'Ocurrió un error. Por favor intente nuevamente.'
        },
        edit: {
            title: 'Editar Clase',
            subtitle: 'Actualizar información y traducciones de la clase',
            backToClasses: 'Volver a Clases',
            loadingClass: 'Cargando clase...',
            failedToLoad: 'Error al cargar clase',
            saving: 'Guardando...',
            saveChanges: 'Guardar Cambios',
            updateSuccess: '¡Clase actualizada exitosamente!',
            updateError: 'Error al actualizar clase',
            cancel: 'Cancelar',
            priceLabel: 'Precio (Colones)',
            activeLabel: 'Activo (visible en el sitio web)',
            titleLabel: 'Título',
            titleRequired: 'Por favor proporcione títulos en todos los idiomas',
            categoryEnglish: 'Categoría (Inglés)',
            categorySpanish: 'Categoría (Español)',
            categoryChinese: '类别 (Chino)',
            levelEnglish: 'Nivel (Inglés)',
            levelSpanish: 'Nivel (Español)',
            levelChinese: '级别 (Chino)',
            autoGenerated: 'Auto-generado desde la selección de categoría arriba',
            autoGeneratedLevel: 'Auto-generado desde la selección de nivel arriba'
        }
    },
    ...
    team : {
        ...
        getStarted: 'Comience agregando su primer miembro del equipo',
        member: 'miembro',
        members: 'miembros',
        orderLabel: 'Orden:',
        inactive: 'Inactivo',
    ...
    hsk : {
        ...
        sessions: {
            ...
            levelLabel: 'Nivel:',
            searchLabel: 'Buscar:',
            searchPlaceholder: 'Buscar ubicación o nivel...',
            clearAll: 'Limpiar todo',
            of: 'de',
            at: 'a las',
            location: 'Ubicación',
    ...
    blog : {
        ...
        subtitle: 'Administra el contenido de tu blog',
