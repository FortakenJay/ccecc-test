export default {
  ...
  blog: {
    ...
    subtitle: 'Gestionar contenido del blog',
    ...
    slugLabel: 'Slug',
    slugPlaceholder: 'slug-generado-automaticamente',
    slugHelp: 'Versión amigable para URL del título',
    excerptLabel: 'Extracto',
    excerptPlaceholder: 'Breve resumen de la publicación',
    seoLabel: 'Descripción SEO',
    seoPlaceholder: 'Descripción meta SEO (150-160 caracteres)',
    contentLabel: 'Contenido',
    contentRequired: 'El contenido es obligatorio',
    contentHelp: 'Escriba el contenido de su publicación. Puede agregar texto, imágenes, encabezados, listas y más.',
    contentPlaceholder: 'Comience a escribir su increíble publicación...',
    publish: 'Publicar',
    ...
    deleteConfirm: '¿Está seguro de que desea eliminar esta publicación? Esta acción no se puede deshacer.',
