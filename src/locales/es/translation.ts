const es = {
    ...
    buttons: {
        ...
        maxSize: "Máx. {size}MB, JPG/PNG/WEBP",
        errorInvalidImage: "Por favor selecciona un archivo de imagen",
        errorImageTooLarge: "El tamaño de la imagen debe ser menor a {size}MB",
    ...
    dashboard: {
        ...
        panel: {
            ...
            manageBlog: 'Administrar blogs',
            manageBlogDesc: 'Crear y actualizar blogs',
            manageHSKsessions: 'Administrar sesiones HSK',
            manageHSKsessionsDesc: 'Crear y actualizar sesiones de examen HSK',
            manageHSkprice: 'Administrar precios HSK',
            manageHSkpriceDesc: 'Crear y actualizar precios de examen HSK',
            manageHSKregistrations: 'Administrar inscripciones HSK',
            manageHSKregistrationsDesc: 'Ver y gestionar inscripciones de estudiantes',
            manageAboutUsTeam: 'Administrar equipo "Sobre Nosotros"',
            manageAboutUsTeamDesc: 'Agregar o editar perfiles de miembros del equipo',
        ...
        blog: {
            ...
            subtitle: 'Gestiona el contenido de tu blog',
            createPost: 'Crear Entrada',
            editPost: 'Editar Entrada',
            update: 'Actualizar publicación del blog',
            deletePost: 'Eliminar publicación del blog',
            totalPosts: 'Total de Entradas',
            published: 'Publicado',
            draft: 'Borrador',
            postTitle: 'Título de la Entrada',
            totalViews: 'Vistas Totales',
            noPostsFound: 'No se encontraron entradas',
            featured: 'Destacado',
            views: 'vistas',
            deleting: 'Eliminando...',
            createNew: 'Crear Nueva Entrada',
            titleLabel: 'Título:',
            slugPlaceholder: 'ingresa-el-slug-del-blog',
            slugHelp: 'Identificador único para la URL de la entrada',
            contentLabel: 'Contenido:',
            excerptLabel: 'Extracto:',
            excerptPlaceholder: 'Resumen corto de la entrada',
            seoLabel: 'Descripción SEO:',
            contentHelp: 'Contenido principal de la entrada, ¡escribe libremente!',
            saveDraft: 'Guardar como Borrador',
            categoryPlaceholder: 'Selecciona una categoría',
            addTag: 'Agregar etiqueta',
            contentPlaceholder: 'Escribe aquí el contenido del blog...',
            tagPlaceholder: 'Ingresa la etiqueta y presiona Enter',
            publishNow: 'Publicar Ahora',
            featuredImage: 'Imagen Destacada:',
            categoryLabel: 'Categoría:',
            tagsLabel: 'Etiquetas:',
            settings: 'Configuración',
            featuredPost: 'Entrada Destacada',
            backToBlog: 'Volver al Blog',
            seoPlaceholder: 'Meta descripción para motores de búsqueda',
            statusLabel: 'Estado:',
            featuredLabel: 'Destacado:',
            publishedAt: 'Publicado en:',
            titlePlaceholder: 'Ingresa el título de la entrada',
            slugLabel: 'Slug:',
            notFeatured: 'No Destacado',
            newestFirst: 'Más Nuevas',
            search: 'Buscar entradas del blog...',
            filterByStatus: 'Filtrar por Estado:',
            filterByFeatured: 'Filtrar por Destacado:',
            ...
            deleteSuccess: 'Entrada eliminada exitosamente',
        ...
        classes: {
            ...
            searchPlaceholder: 'Buscando classes...',
        ...
        hsk: {
            ...
            sessions: {
                ...
                searchPlaceholder: 'Buscar sesiones de examen...',
        ...
        nav: {
            ...
            users: 'Usuarios del personal',
            adminPanel: 'Panel de administración',
            classes: 'Clases',
            team: 'Miembros de CCECC',
            hskExam: 'Examen HSK',
            hskprice: 'Precios HSK',
            hskRegistrations: 'Inscripciones HSK',
            hsk: 'Exámenes HSK',
